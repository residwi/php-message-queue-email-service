...
CREATE DATABASE email_service WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.UTF-8' LC_CTYPE = 'en_US.UTF-8';
...
COPY public.logs (id, email, subject, body) FROM stdin;
\.
